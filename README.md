...
mkdir tmp/database
podman run --name stagepick-database -p 5432:5432 --network stagepick -e POSTGRES_PASSWORD= -v ./tmp/database:/ docker.io/postgres:18.4
```
